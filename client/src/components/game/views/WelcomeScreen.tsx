...
export const WelcomeScreen = () => {
    return (
        <div className="flex justify-center items-center min-h-screen p-4 welcome-screen"
        >
            <div className='scan-lines'></div>
            <div className='vignette'></div>
            <div className="nes-container is-dark with-title h-120 w-9/12 !bg-black !border-2 !border-[#209cee]">
