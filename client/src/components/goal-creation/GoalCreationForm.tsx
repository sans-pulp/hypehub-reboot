...
import { AttributeCheckboxes, AttributeRewards, GoalFormField, SelectGoalType, TargetDateField } from "./components"
          ...
          <div className="grid gap-4 py-4">
            ...
            <div>
              ...
              <AttributeRewards
                ...
                attributePoints={formData.attributePoints}
                setAttributePoints={(points) => setformData((prev) => ({...prev, attributePoints: points}))}
              />
